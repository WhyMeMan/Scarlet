...
public class ConsoleGuiChat extends GuiScreen
{
    ...
    /*Instance of the Nero Console*/
    private Console console;
    
    public ConsoleGuiChat(Console console) 
    { 
    ...
    public ConsoleGuiChat(String par1Str)
    {
    ...
    {
    	/**
         * All instances of this.mc.ingameGUI.getChatGUI() in this class have been changed to the
         * private variable console with: console.getChatGUI()
         */
    	
        Keyboard.enableRepeatEvents(true);
        //this.sentHistoryCursor = this.mc.ingameGUI.getChatGUI().getSentMessages().size();
        
        this.sentHistoryCursor = console.getChatGUI().getSentMessages().size();
    ...
    public void onGuiClosed()
    {
        ...
        console.getChatGUI().resetScroll();
    ...
    protected void keyTyped(char par1, int par2)
    {
        ...
        else if (par2 == 28)
        {
            ...
            if (var3.length() > 0)
            {
                this.console.getChatGUI().addToSentMessages(var3);
        ...
        {
            this.console.getChatGUI().scroll(19);
        }
        else if (par2 == 209)
        {
            this.console.getChatGUI().scroll(-19);
    ...
    public void handleMouseInput()
    {
        ...
        if (var1 != 0)
        {
            ...
            this.console.getChatGUI().scroll(var1);
        }
    }
    ...
    public void completePlayerName()
    {
        ...
        if (this.field_73904_o.size() > 1)
        {
            ...
            this.console.getChatGUI().printChatMessageWithOptionalDeletion(var4.toString(), 1);
        }
    ...
    public void getSentHistory(int par1)
    {
        ...
        int var3 = this.console.getChatGUI().getSentMessages().size();
        ...
        if (var2 != this.sentHistoryCursor)
        {
            ...
            else
            {
                ...
                this.inputField.setText((String)this.console.getChatGUI().getSentMessages().get(var2));
