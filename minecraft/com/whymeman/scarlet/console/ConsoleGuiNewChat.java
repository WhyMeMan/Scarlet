...
import com.whymeman.scarlet.util.font.TTF;

public class ConsoleGuiNewChat extends Gui
{
        ...
        if (this.mc.gameSettings.chatVisibility != 2)
        {
            ...
            if (var5 > 0)
            {
				...
				if (c != 0) { // && Pringles.manager.chat.isEnabled()) {
					drawBorderedRect(3, 0 - (c * 9 + 7), 327, 0 - (c * 9 - 5), 1, -15658735, true);//, -2146365167);
					TTF.drawShadowString(font, "Chat", 5,
							2 - (c * 9 + 6), org.newdawn.slick.Color.decode("0xFFFFFF"));
                    drawBorderedRect(3, -c * 9 + 7, 327, -c * 9 + 12 + line - 2, 1, -15658735, true);// -2146365167);
				}
                        ...
                        if (var9 < 200 || var3)
                        {
                            ...
                            if (var12 > 3)
                            {
								...
								//if (!Pringles.manager.chat.isEnabled())
									drawRect(var13, var14 - 1, 327, var14 + 8,
											var12 / 2 << 24);
                                ...
                                TTF.drawShadowString(font, var15, var13, var14, org.newdawn.slick.Color.decode("0xFFFFFF"));//16777215 + org.newdawn.slick.Color((var12 << 24)));                                
                                //chong = var12;
                            }
                        }
                    }
    ...
    {
        return this.mc.currentScreen instanceof ConsoleGuiChat || this.mc.currentScreen instanceof GuiChat;
    }
